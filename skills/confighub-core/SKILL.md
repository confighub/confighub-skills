...
- **Every mutating call should pass `--display-mutation`** to show the diff inline.
...
- `references/cub-cli.md` — CLI conventions, Read/Write permission sets, agent-mode help, `--change-desc`, `--display-mutation`.
